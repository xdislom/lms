...
export default function MaterialsPage({
  ...
  const loadData = () => {
    ...
    Promise.all([
      ...
      .then(([matsRes, lessonRes, catsRes]) => {
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2 mb-6">
        <Link href={`/admin/categories/${categoryId}/sections/${sectionId}/lessons/${lessonId}/materials`}>
          <div className="bg-blue-500 text-white px-6 py-2 rounded-xl text-sm font-medium shadow-sm transition-colors cursor-pointer">
            Materiallar
          </div>
        </Link>
        <Link href={`/admin/categories/${categoryId}/sections/${sectionId}/lessons/${lessonId}/homeworks`}>
        ...
        <Link href={`/admin/categories/${categoryId}/sections/${sectionId}/lessons/${lessonId}/exams`}>
          <div className="bg-white text-slate-500 hover:bg-slate-50 hover:text-slate-700 px-6 py-2 rounded-xl text-sm font-medium border border-slate-200 transition-colors cursor-pointer">
            Imtihonlar
          </div>
        </Link>
                    ...
                    <td className="px-4 py-4">
                      <div className="flex flex-wrap gap-2">
                        {mat.materialFiles?.map(f => (
                          <a
                            key={f.id}
                            href={`http://localhost:3001/uploads/materials/${f.file}`}
                            target="_blank"
